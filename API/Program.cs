...
builder.Services.AddScoped<IPayGradeService, PayGradeService>();
...
builder.Services.AddScoped<ITimeAllocationService, TimeAllocationService>();
...
//Inject context
builder.Services.AddTransient<DemoApplicationContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoApplication API v1");
